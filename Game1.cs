...
namespace BlockGame
{
    public class Game1 : Game
    {
        ...
        private SkinnedEffect skinEffect;
        ...
        protected override void Initialize()
        {
            ...
            player = new Player(_graphics.GraphicsDevice, new Vector3(0f, 25, 0f), Vector3.Zero, world);

            //Debug inits
            characterModel = Content.Load<SkinnedModel>("Male");
            characterText = Content.Load<Texture2D>("MaleTexture");
